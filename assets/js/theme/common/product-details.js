...
export default class ProductDetails {
    ...
    initCustomTabs() {
        ...
        $customTabs.each((i, el) => {
            ...
            $tabsContent.append(`<div class="tab-content tab-content--custom tab-content--custom-${i}" id="tab-custom-${i}" data-papathemes-mobile-collapse><div class="container"><h2 class="beautify__page-heading _hasToggle">${title}</h2><div class="productView-custom-tabContent papathemes-mobile-collapse-content" data-papathemes-mobile-collapse-content>${content}</div><a href="#" class="papathemes-mobile-collapse-handle" data-papathemes-mobile-collapse-handle><span class="on">${expand}</span><span class="off">${close}</span></a></div></div>`);
        });
    }
